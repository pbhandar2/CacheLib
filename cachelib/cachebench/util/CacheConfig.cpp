...
CacheConfig::CacheConfig(const folly::dynamic& configJson) {
  ...
  JSONSetVal(configJson, navyAdmissionProbability);
  JSONSetVal(configJson, navyMaxDeviceWriteRateMB);

  
  JSONSetVal(configJson, navySetRejectFirstAP);
  JSONSetVal(configJson, navyRejectFirstAPEntryCount);
  JSONSetVal(configJson, navyRejectFirstAPSplitCount);
  JSONSetVal(configJson, navyRejectFirstAPDRAMHints);
